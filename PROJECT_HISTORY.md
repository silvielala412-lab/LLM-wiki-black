...
| 编号 | 问题 | 状态 | 记录时间 |
|---|---|---|---|
| Q001 | product_catalog 前端上传时是否需要手动选择 domain | ⏳ 待产品确认 | 2026-06-14 |
| Q002 | 是否需要新建独立「产品库」浏览页面 | ⏳ 待产品确认 | 2026-06-14 |
| Q003 | DEDUP_KEY_FIELDS 里 product_overview/rate_table 去重字段确认 | ⏳ 待确认 | 2026-06-14 |
| Q004 | 险种产品和服务手册重叠时（如臻享家医既有服务手册又有险种条款）合并还是分页关联？ | ⏳ 待确认 | 2026-06-14 |
